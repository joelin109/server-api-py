...
from src.service.api.crawler import CrawlerArticleApi, CrawlerArticleBodyApi, CrawlerHttpURLApi
...
def register_api_add_resource(app):
    ...
    rest_api.add_resource(CrawlerHttpURLApi, Conf.APIURL_Content_Crawler_Http_URL)
